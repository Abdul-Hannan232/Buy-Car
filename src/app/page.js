  ...
  return (
    <>
      <div className='homebanner w-full md:h-[80vh] h-[40vh] flex flex-col justify-end text-center items-end'>
        <div className='md:w-[50%] w-[80%] mx-auto md:mb-20 mb-5'>
          ...
          <div className='w-full relative md:mt-5 mt-3'>
      ...
      <div className='md:w-[80%] w-[90%] mx-auto md:mt-14 mt-5'> <div className=' mt-20 flex items-center justify-between'>
        ...
        <button className=' buttonBackground md:w-60 w-40 md:p-5 p-3 rounded-2xl  text-center text-lg text-white  flex justify-center mx-auto mt-10 mb-32'>Show more cars</button>
      </div>
    </>
  )
}
