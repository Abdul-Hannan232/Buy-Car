        ...
        <div className='flex  mt-32 gap-10 w-[85%] mx-auto '>
            ...
            <div className='w-full  bg-white p-3 rounded-xl'>
                ...
                <div className='relative  w-full'>
                    <h1 className='text-xm text-black absolute left-3 top-3'>Name</h1>
                ...
                <div className='relative mt-3 w-full'>
                    <h1 className='text-xm text-black absolute left-3 top-3'>Email  </h1>
                ...
                <div className='relative mt-3 w-full'>
                    <h1 className='text-xm text-black absolute left-3 top-3'>Phone</h1>
                ...
                <div className='relative mt-3 w-full'>
                    <h1 className='text-xm text-black absolute left-3 top-3'>Reason For Contact</h1>
                ...
                <div className='relative   mt-3    w-full'>
                    <h1 className='text-xm text-black absolute left-3 top-3'>Message</h1>
